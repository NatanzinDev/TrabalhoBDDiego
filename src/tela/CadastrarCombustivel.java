...
public class CadastrarCombustivel extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					CadastrarCombustivel frame = new CadastrarCombustivel();
	 ...
	 */
	public CadastrarCombustivel() throws ClassNotFoundException, SQLException {
